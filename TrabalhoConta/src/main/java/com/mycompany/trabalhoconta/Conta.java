...
//    }   
    ...
    public Conta(String nome, String cpf, String email, int numeroConta, double saldo, String tipoConta) {
    ...
    public void informaSaldo() {
        System.out.println("O saldo atual da conta do(a): " + this + " é igual a: " + this.saldo);
    }
